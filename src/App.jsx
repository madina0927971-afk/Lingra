...
const NATIVE_LANGS = [
  { code: "ru", name: "Р СѓСЃСЃРєРёР№", flag: "рџ‡·рџ‡є", img: "ru" },
  { code: "uz", name: "O'zbek", flag: "рџ‡єрџ‡ї", img: "uz" },
];
...
const FLAG_EMOJI = {
  ru:"рџ‡·рџ‡є", uz:"рџ‡єрџ‡ї", gb:"рџ‡¬рџ‡§", en:"рџ‡¬рџ‡§",
  de:"рџ‡©рџ‡Є", tr:"рџ‡№рџ‡·", sa:"рџ‡ёрџ‡¦", ir:"рџ‡®рџ‡·",
  cn:"рџ‡Ёрџ‡і", es:"рџ‡Єрџ‡ё",
};
...
const UI = {
  ...
  tr: {
    selectNative:"Ana dilinizi seГ§in", chooseToLearn:"Г–ДћRENД°LECEK DД°LLER",
    days:"gГјn", xp:"XP", langs:"dil", pricingBtn:"рџ’Ћ Fiyatlar",
    lessons:"DERSLER", words:"kelime", questions:"alД±ЕџtД±rma",
    aiTitle:"AI Г–Дџretmen", aiOnline:"в—Џ Г§evrimiГ§i", aiPlaceholder:"YazД±n...",
    pricing:"Fiyatlar", langPrice:"Dil baЕџД±na $10/ay",
    free4th:"3 dil в†’ 4. BEDAVA (-$10)",
    free6th:"5 dil в†’ 6. BEDAVA + $5 indirim/ay",
    selectedLangs:"SeГ§ilen", total:"Toplam", discount:"Д°ndirim",
    free:"bedava", subscribe:"Abone Ol",
    level:"SEVД°YE", beginner:"BaЕџlangД±Г§", intermediate:"Orta", advanced:"Д°leri",
    levelDesc1:"Alfabe, temel kelimeler", levelDesc2:"Diyaloglar, gramer",
    levelDesc3:"AkД±cД±lД±k, iЕџ dili", selectLevel:"Seviye seГ§",
    month:"/ay", next:"Д°leri в†’", back:"в†ђ Geri", check:"Kontrol Et",
    correct:"DoДџru! рџЋ‰", wrong:"YanlД±Еџ", lives:"Canlar",
    lessonDone:"Ders Bitti!", result:"SonuГ§", continueBtn:"Devam",
    exerciseTypes:{ translate:"CГјmleyi Г§evirin", arrange:"Kelimeleri sД±ralayД±n", fill:"BoЕџluДџu doldurun", choose:"Г‡eviriyi seГ§in", listen:"Dinle ve yaz" },
    tapWords:"Kelimelere sД±rayla dokunun", typeAnswer:"CevabД±nД±zД± yazД±n...",
    livesOut:"Canlar bitti!", tryAgain:"Tekrar dene",
    streak:"Seri", perfect:"MГјkemmel! в­ђ",
    hintBtn:"Д°pucu", hintUsed:"Д°pucu kullanД±ldД±",
  },
  ar: {
    selectNative:"Ш§Ш®ШЄШ± Щ„ШєШЄЩѓ Ш§Щ„ШЈЩ…", chooseToLearn:"Ш§Щ„Щ„ШєШ§ШЄ Щ„Щ„ШЄШ№Щ„Щ…",
    days:"ШЈЩЉШ§Щ…", xp:"XP", langs:"Щ„ШєШ§ШЄ", pricingBtn:"рџ’Ћ Ш§Щ„ШЈШіШ№Ш§Ш±",
    lessons:"Ш§Щ„ШЇШ±Щ€Ші", words:"ЩѓЩ„Щ…Ш§ШЄ", questions:"ШЄЩ…Ш±ЩЉЩ†",
    aiTitle:"Щ…ШЇШ±ШЁ AI", aiOnline:"в—Џ Щ…ШЄШµЩ„", aiPlaceholder:"Ш§ЩѓШЄШЁ...",
    pricing:"Ш§Щ„ШЈШіШ№Ш§Ш±", langPrice:"$10/ШґЩ‡Ш± Щ„ЩѓЩ„ Щ„ШєШ©",
    free4th:"3 Щ„ШєШ§ШЄ в†ђ Ш§Щ„Щ„ШєШ© Ш§Щ„Ш±Ш§ШЁШ№Ш© Щ…Ш¬Ш§Щ†ЩЉШ© (-$10)",
    free6th:"5 Щ„ШєШ§ШЄ в†ђ Ш§Щ„ШіШ§ШЇШіШ© Щ…Ш¬Ш§Щ†ЩЉШ© + $5/ШґЩ‡Ш±",
    selectedLangs:"Ш§Щ„Щ…Ш®ШЄШ§Ш±Ш©", total:"Ш§Щ„Щ…Ш¬Щ…Щ€Ш№", discount:"Ш®ШµЩ…",
    free:"Щ…Ш¬Ш§Щ†ЩЉ", subscribe:"Ш§ШґШЄШ±Щѓ",
    level:"Ш§Щ„Щ…ШіШЄЩ€Щ‰", beginner:"Щ…ШЁШЄШЇШ¦", intermediate:"Щ…ШЄЩ€ШіШ·", advanced:"Щ…ШЄЩ‚ШЇЩ…",
    levelDesc1:"Ш§Щ„ШЈШЁШ¬ШЇЩЉШ©ШЊ ЩѓЩ„Щ…Ш§ШЄ ШЈШіШ§ШіЩЉШ©", levelDesc2:"Ш­Щ€Ш§Ш±Ш§ШЄШЊ Щ‚Щ€Ш§Ш№ШЇ",
    levelDesc3:"Ш·Щ„Ш§Щ‚Ш©ШЊ Щ„ШєШ© Ш§Щ„ШЈШ№Щ…Ш§Щ„", selectLevel:"Ш§Ш®ШЄШ± Ш§Щ„Щ…ШіШЄЩ€Щ‰",
    month:"/ШґЩ‡Ш±", next:"Ш§Щ„ШЄШ§Щ„ЩЉ в†’", back:"в†’ Ш±Ш¬Щ€Ш№", check:"ШЄШ­Щ‚Щ‚",
    correct:"ШµШ­ЩЉШ­! рџЋ‰", wrong:"Ш®Ш·ШЈ", lives:"Ш§Щ„ШЈШ±Щ€Ш§Ш­",
    lessonDone:"Ш§ЩѓШЄЩ…Щ„ Ш§Щ„ШЇШ±Ші!", result:"Ш§Щ„Щ†ШЄЩЉШ¬Ш©", continueBtn:"Ш§ШіШЄЩ…Ш±",
    exerciseTypes:{ translate:"ШЄШ±Ш¬Щ… Ш§Щ„Ш¬Щ…Щ„Ш©", arrange:"Ш±ШЄШЁ Ш§Щ„ЩѓЩ„Щ…Ш§ШЄ", fill:"Ш§Щ…Щ„ШЈ Ш§Щ„ЩЃШ±Ш§Шє", choose:"Ш§Ш®ШЄШ± Ш§Щ„ШЄШ±Ш¬Щ…Ш©", listen:"Ш§ШіШЄЩ…Ш№ Щ€Ш§ЩѓШЄШЁ" },
    tapWords:"Ш§Щ†Щ‚Ш± Ш№Щ„Щ‰ Ш§Щ„ЩѓЩ„Щ…Ш§ШЄ ШЁШ§Щ„ШЄШ±ШЄЩЉШЁ", typeAnswer:"Ш§ЩѓШЄШЁ ШҐШ¬Ш§ШЁШЄЩѓ...",
    livesOut:"Щ†ЩЃШЇШЄ Ш§Щ„ШЈШ±Щ€Ш§Ш­!", tryAgain:"Ш­Ш§Щ€Щ„ Щ…Ш±Ш© ШЈШ®Ш±Щ‰",
    streak:"ШіЩ„ШіЩ„Ш©", perfect:"Щ…Ш«Ш§Щ„ЩЉ! в­ђ",
    hintBtn:"ШЄЩ„Щ…ЩЉШ­", hintUsed:"ШЄЩ… Ш§ШіШЄШ®ШЇШ§Щ… Ш§Щ„ШЄЩ„Щ…ЩЉШ­",
  },
  fa: {
    selectNative:"ШІШЁШ§Щ† Щ…Ш§ШЇШ±ЫЊ Ш®Щ€ШЇ Ш±Ш§ Ш§Щ†ШЄШ®Ш§ШЁ Ъ©Щ†ЫЊШЇ", chooseToLearn:"ШІШЁШ§Щ†вЂЊЩ‡Ш§ЫЊ ЫЊШ§ШЇЪЇЫЊШ±ЫЊ",
    days:"Ш±Щ€ШІ", xp:"XP", langs:"ШІШЁШ§Щ†", pricingBtn:"рџ’Ћ Щ‚ЫЊЩ…ШЄвЂЊЩ‡Ш§",
    lessons:"ШЇШ±ШівЂЊЩ‡Ш§", words:"Ъ©Щ„Щ…Щ‡", questions:"ШЄЩ…Ш±ЫЊЩ†",
    aiTitle:"Щ…Ш±ШЁЫЊ AI", aiOnline:"в—Џ ШўЩ†Щ„Ш§ЫЊЩ†", aiPlaceholder:"ШЁЩ†Щ€ЫЊШіЫЊШЇ...",
    pricing:"Щ‚ЫЊЩ…ШЄвЂЊЩ‡Ш§", langPrice:"$10/Щ…Ш§Щ‡ ШЁШ±Ш§ЫЊ Щ‡Ш± ШІШЁШ§Щ†",
    free4th:"3 ШІШЁШ§Щ† в†ђ Ъ†Щ‡Ш§Ш±Щ… Ш±Ш§ЫЊЪЇШ§Щ† (-$10)",
    free6th:"5 ШІШЁШ§Щ† в†ђ ШґШґЩ… Ш±Ш§ЫЊЪЇШ§Щ† + $5/Щ…Ш§Щ‡",
    selectedLangs:"Ш§Щ†ШЄШ®Ш§ШЁ ШґШЇЩ‡", total:"Ш¬Щ…Ш№", discount:"ШЄШ®ЩЃЫЊЩЃ",
    free:"Ш±Ш§ЫЊЪЇШ§Щ†", subscribe:"Ш§ШґШЄШ±Ш§Ъ©",
    level:"ШіШ·Ш­", beginner:"Щ…ШЁШЄШЇЫЊ", intermediate:"Щ…ШЄЩ€ШіШ·", advanced:"ЩѕЫЊШґШ±ЩЃШЄЩ‡",
    levelDesc1:"Ш§Щ„ЩЃШЁШ§ШЊ Ъ©Щ„Щ…Ш§ШЄ ЩѕШ§ЫЊЩ‡", levelDesc2:"ЪЇЩЃШЄЪЇЩ€ШЊ ШЇШіШЄЩ€Ш± ШІШЁШ§Щ†",
    levelDesc3:"Ш±Щ€Ш§Щ†ЫЊШЊ ШІШЁШ§Щ† ШЄШ¬Ш§Ш±ЫЊ", selectLevel:"ШіШ·Ш­ Ш±Ш§ Ш§Щ†ШЄШ®Ш§ШЁ Ъ©Щ†ЫЊШЇ",
    month:"/Щ…Ш§Щ‡", next:"ШЁШ№ШЇЫЊ в†’", back:"в†ђ ШЁШ±ЪЇШґШЄ", check:"ШЁШ±Ш±ШіЫЊ",
    correct:"ШЇШ±ШіШЄ! рџЋ‰", wrong:"Ш§ШґШЄШЁШ§Щ‡", lives:"Ш¬Ш§Щ†вЂЊЩ‡Ш§",
    lessonDone:"ШЇШ±Ші ШЄЩ…Ш§Щ… ШґШЇ!", result:"Щ†ШЄЫЊШ¬Щ‡", continueBtn:"Ш§ШЇШ§Щ…Щ‡",
    exerciseTypes:{ translate:"Ш¬Щ…Щ„Щ‡ Ш±Ш§ ШЄШ±Ш¬Щ…Щ‡ Ъ©Щ†ЫЊШЇ", arrange:"Ъ©Щ„Щ…Ш§ШЄ Ш±Ш§ Щ…Ш±ШЄШЁ Ъ©Щ†ЫЊШЇ", fill:"Ш¬Ш§ЫЊ Ш®Ш§Щ„ЫЊ Ш±Ш§ ЩѕШ± Ъ©Щ†ЫЊШЇ", choose:"ШЄШ±Ш¬Щ…Щ‡ Ш±Ш§ Ш§Щ†ШЄШ®Ш§ШЁ Ъ©Щ†ЫЊШЇ", listen:"ШЁШґЩ†Щ€ЫЊШЇ Щ€ ШЁЩ†Щ€ЫЊШіЫЊШЇ" },
    tapWords:"Ш±Щ€ЫЊ Ъ©Щ„Щ…Ш§ШЄ ШЁЩ‡ ШЄШ±ШЄЫЊШЁ ШЁШІЩ†ЫЊШЇ", typeAnswer:"Ш¬Щ€Ш§ШЁ Ш±Ш§ ШЁЩ†Щ€ЫЊШіЫЊШЇ...",
    livesOut:"Ш¬Ш§Щ†вЂЊЩ‡Ш§ ШЄЩ…Ш§Щ… ШґШЇ!", tryAgain:"ШЇЩ€ШЁШ§Ш±Щ‡ Ш§Щ…ШЄШ­Ш§Щ† Ъ©Щ†ЫЊШЇ",
    streak:"ШіШ±ЫЊ", perfect:"Ш№Ш§Щ„ЫЊ! в­ђ",
    hintBtn:"Ш±Ш§Щ‡Щ†Щ…Ш§", hintUsed:"Ш±Ш§Щ‡Щ†Щ…Ш§ Ш§ШіШЄЩЃШ§ШЇЩ‡ ШґШЇ",
  },
  zh: {
    selectNative:"йЂ‰ж‹©ж‚Ёзљ„жЇЌиЇ­", chooseToLearn:"е­¦д№ иЇ­иЁЂ",
    days:"е¤©", xp:"XP", langs:"иЇ­иЁЂ", pricingBtn:"рџ’Ћ д»·ж ј",
    lessons:"иЇѕзЁ‹", words:"еЌ•иЇЌ", questions:"з»ѓд№ ",
    aiTitle:"AIеЇјеё€", aiOnline:"в—Џ ењЁзєї", aiPlaceholder:"иѕ“е…Ґ...",
    pricing:"д»·ж ј", langPrice:"жЇЏз§ЌиЇ­иЁЂ$10/жњ€",
    free4th:"3иЇ­иЁЂв†’з¬¬4дёЄе…Ќиґ№(-$10)",
    free6th:"5иЇ­иЁЂв†’з¬¬6дёЄе…Ќиґ№+$5/жњ€",
    selectedLangs:"е·ІйЂ‰", total:"еђ€и®Ў", discount:"дјжѓ ",
    free:"е…Ќиґ№", subscribe:"и®ўй…",
    level:"зє§е€«", beginner:"е€ќзє§", intermediate:"дё­зє§", advanced:"й«зє§",
    levelDesc1:"е­—жЇЌгЂЃеџєзЎЂиЇЌж±‡", levelDesc2:"еЇ№иЇќгЂЃиЇ­жі•",
    levelDesc3:"жµЃе€©гЂЃе•†еЉЎиЇ­иЁЂ", selectLevel:"йЂ‰ж‹©зє§е€«",
    month:"/жњ€", next:"дё‹дёЂж­Ґ в†’", back:"в†ђ иї”е›ћ", check:"жЈЂжџҐ",
    correct:"ж­ЈзЎ®пјЃрџЋ‰", wrong:"й”™иЇЇ", lives:"з”џе‘Ѕ",
    lessonDone:"иЇѕзЁ‹е®Њж€ђпјЃ", result:"з»“жћњ", continueBtn:"з»§з»­",
    exerciseTypes:{ translate:"зї»иЇ‘иї™дёЄеЏҐе­ђ", arrange:"жЋ’е€—еЌ•иЇЌ", fill:"еЎ«з©є", choose:"йЂ‰ж‹©зї»иЇ‘", listen:"еђ¬е†™" },
    tapWords:"жЊ‰йЎєеєЏз‚№е‡»еЌ•иЇЌ", typeAnswer:"иѕ“е…Ґз­”жЎ€...",
    livesOut:"з”џе‘Ѕз”Ёе®Њдє†пјЃ", tryAgain:"е†ЌиЇ•дёЂж¬Ў",
    streak:"иїћз»­", perfect:"е®ЊзѕЋпјЃв­ђ",
    hintBtn:"жЏђз¤є", hintUsed:"е·Із”ЁжЏђз¤є",
  },
  es: {
    selectNative:"Elige tu idioma nativo", chooseToLearn:"IDIOMAS PARA APRENDER",
    days:"dГ­as", xp:"XP", langs:"idiomas", pricingBtn:"рџ’Ћ Precios",
    lessons:"LECCIONES", words:"palabras", questions:"ejercicios",
    aiTitle:"Tutor AI", aiOnline:"в—Џ en lГ­nea", aiPlaceholder:"Escribe...",
    pricing:"Precios", langPrice:"$10/mes por idioma",
    free4th:"3 idiomas в†’ 4Вє GRATIS (-$10)",
    free6th:"5 idiomas в†’ 6Вє GRATIS + $5 dto./mes",
    ...
    levelDesc1:"Alfabeto, palabras bГЎsicas", levelDesc2:"DiГЎlogos, gramГЎtica",
    levelDesc3:"Fluidez, lenguaje de negocios", selectLevel:"Elige nivel",
    month:"/mes", next:"Siguiente в†’", back:"в†ђ AtrГЎs", check:"Comprobar",
    correct:"ВЎCorrecto! рџЋ‰", wrong:"Incorrecto", lives:"Vidas",
    lessonDone:"ВЎLecciГіn completada!", result:"Resultado", continueBtn:"Continuar",
    exerciseTypes:{ translate:"Traduce la frase", arrange:"Ordena las palabras", fill:"Rellena el hueco", choose:"Elige la traducciГіn", listen:"Escucha y escribe" },
    tapWords:"Toca las palabras en orden", typeAnswer:"Escribe tu respuesta...",
    livesOut:"ВЎSin vidas!", tryAgain:"Intentar de nuevo",
    streak:"Racha", perfect:"ВЎPerfecto! в­ђ",
    hintBtn:"Pista", hintUsed:"Pista usada",
  },
  de: {
    selectNative:"WГ¤hle deine Muttersprache", chooseToLearn:"SPRACHEN LERNEN",
    days:"Tage", xp:"XP", langs:"Sprachen", pricingBtn:"рџ’Ћ Preise",
    lessons:"LEKTIONEN", words:"WГ¶rter", questions:"Aufgaben",
    aiTitle:"AI Tutor", aiOnline:"в—Џ online", aiPlaceholder:"Schreiben...",
    pricing:"Preise", langPrice:"$10/Monat pro Sprache",
    free4th:"3 Sprachen в†’ 4. GRATIS (-$10)",
    free6th:"5 Sprachen в†’ 6. GRATIS + $5 Rabatt/Monat",
    selectedLangs:"AusgewГ¤hlt", total:"Gesamt", discount:"Rabatt",
    free:"gratis", subscribe:"Abonnieren",
    level:"NIVEAU", beginner:"AnfГ¤nger", intermediate:"Mittelstufe", advanced:"Fortgeschritten",
    levelDesc1:"Alphabet, GrundwГ¶rter", levelDesc2:"Dialoge, Grammatik",
    levelDesc3:"FlieГџend, GeschГ¤ftssprache", selectLevel:"Niveau wГ¤hlen",
    month:"/Monat", next:"Weiter в†’", back:"в†ђ ZurГјck", check:"PrГјfen",
    correct:"Richtig! рџЋ‰", wrong:"Falsch", lives:"Leben",
    lessonDone:"Lektion abgeschlossen!", result:"Ergebnis", continueBtn:"Weiter",
    exerciseTypes:{ translate:"Гњbersetze den Satz", arrange:"Ordne die WГ¶rter", fill:"FГјlle die LГјcke aus", choose:"WГ¤hle die Гњbersetzung", listen:"HГ¶r zu und schreibe" },
    tapWords:"Tippe die WГ¶rter der Reihe nach", typeAnswer:"Deine Antwort...",
    livesOut:"Keine Leben mehr!", tryAgain:"Nochmal versuchen",
    streak:"Serie", perfect:"Perfekt! в­ђ",
  ...
  "tr-beginner": [
    {
      id:1, emoji:"рџ‘‹", titles:{ ru:"РџСЂРёРІРµС‚СЃС‚РІРёСЏ", en:"Greetings", uz:"Salomlashish", tr:"SelamlaЕџma", ar:"Ш§Щ„ШЄШ­ЩЉШ§ШЄ", fa:"Ш§Ш­Щ€Ш§Щ„вЂЊЩѕШ±ШіЫЊ", zh:"й—®еЂ™", es:"Saludos", de:"BegrГјГџungen" },
      exercises: [
        { type:"choose", targetWord:"Merhaba", translations:{ ru:"РџСЂРёРІРµС‚", en:"Hello", uz:"Salom", tr:"Selam", ar:"Щ…Ш±Ш­ШЁШ§", fa:"ШіЩ„Ш§Щ…", zh:"дЅ еҐЅ", es:"Hola", de:"Hallo" }, distractors:{ ru:["РџРѕРєР°","РЎРїР°СЃРёР±Рѕ","РР·РІРёРЅРё"], en:["Bye","Thanks","Sorry"], uz:["Xayr","Rahmat","Kechirasiz"], tr:["HoЕџГ§a kal","TeЕџekkГјrler","Г–zГјr"], ar:["Щ€ШЇШ§Ш№Ш§","ШґЩѓШ±Ш§","ШўШіЩЃ"], fa:["Ш®ШЇШ§Ш­Ш§ЩЃШё","Щ…Щ…Щ†Щ€Щ†","ШЁШЁШ®ШґЫЊШЇ"], zh:["е†Ќи§Ѓ","и°ўи°ў","еЇ№дёЌиµ·"], es:["AdiГіs","Gracias","PerdГіn"], de:["TschГјss","Danke","Entschuldigung"] } },
        { type:"arrange", sentence:{ ru:"РџСЂРёРІРµС‚ РєР°Рє РґРµР»Р°", en:"Hello how are you", uz:"Salom qandaysiz", tr:"Merhaba nasД±lsД±n", ar:"Щ…Ш±Ш­ШЁШ§ ЩѓЩЉЩЃ Ш­Ш§Щ„Щѓ", fa:"ШіЩ„Ш§Щ… Ш­Ш§Щ„ШЄ Ъ†Ш·Щ€Ш±", zh:"дЅ еҐЅдЅ еҐЅеђ—", es:"Hola cГіmo estГЎs", de:"Hallo wie geht es dir" }, answer:"Merhaba nasД±lsД±n", words:["Merhaba","nasД±lsД±n","GГјle","gГјle","nereye"] },
        { type:"fill", sentence:"___ iГ§in teЕџekkГјrler!", blank:"Her Еџey", hint:{ ru:"РЎРїР°СЃРёР±Рѕ Р·Р° РІСЃС‘!", en:"Thank you for everything!", uz:"Hamma narsa uchun rahmat!", tr:"Her Еџey iГ§in teЕџekkГјrler!", ar:"ШґЩѓШ±Ш§ Ш№Щ„Щ‰ ЩѓЩ„ ШґЩЉШЎ!", fa:"ШЁШ±Ш§ЫЊ Щ‡Щ…Щ‡ Ъ†ЫЊШІ Щ…Щ…Щ†Щ€Щ†!", zh:"ж„џи°ўдёЂе€‡пјЃ", es:"ВЎGracias por todo!", de:"Danke fГјr alles!" }, options:["Her Еџey","HiГ§bir Еџey","Yemek","Para"] },
        { type:"translate", source:{ ru:"РџРѕРєР°, РґРѕ Р·Р°РІС‚СЂР°!", en:"Bye, see you tomorrow!", uz:"Xayr, ertaga ko'rishguncha!", tr:"Bye, see you tomorrow!", ar:"Щ€ШЇШ§Ш№Ш§ШЊ ШЈШ±Ш§Щѓ ШєШЇШ§!", fa:"Ш®ШЇШ§Ш­Ш§ЩЃШёШЊ ШЄШ§ ЩЃШ±ШЇШ§!", zh:"е†Ќи§ЃпјЊжЋе¤©и§ЃпјЃ", es:"ВЎAdiГіs, hasta maГ±ana!", de:"TschГјss, bis morgen!" }, answer:"gГјle gГјle yarД±n gГ¶rГјЕџГјrГјz", accept:["gГјle gГјle yarД±n gГ¶rГјЕџГјrГјz","gГјle gГјle yarД±n gГ¶rГјЕџelim","hoЕџГ§a kal yarД±n gГ¶rГјЕџГјrГјz"] },
        { type:"choose", targetWord:"LГјtfen", translations:{ ru:"РџРѕР¶Р°Р»СѓР№СЃС‚Р°", en:"Please", uz:"Iltimos", tr:"Rica ederim", ar:"Щ…Щ† ЩЃШ¶Щ„Щѓ", fa:"Щ„Ш·ЩЃШ§Щ‹", zh:"иЇ·", es:"Por favor", de:"Bitte" }, distractors:{ ru:["РќРµС‚","Р”Р°","РњРѕР¶РµС‚ Р±С‹С‚СЊ"], en:["No","Yes","Maybe"], uz:["Yo'q","Ha","Balki"], tr:["HayД±r","Evet","Belki"], ar:["Щ„Ш§","Щ†Ш№Щ…","Ш±ШЁЩ…Ш§"], fa:["Щ†Щ‡","ШЁЩ„Щ‡","ШґШ§ЫЊШЇ"], zh:["дёЌ","жЇ","д№џи®ё"], es:["No","SГ­","QuizГЎs"], de:["Nein","Ja","Vielleicht"] } },
      ]
    },
    {
      id:2, emoji:"рџ”ў", titles:{ ru:"Р§РёСЃР»Р°", en:"Numbers", uz:"Raqamlar", tr:"SayД±lar", ar:"Ш§Щ„ШЈШ±Щ‚Ш§Щ…", fa:"Ш§Ш№ШЇШ§ШЇ", zh:"ж•°е­—", es:"NГєmeros", de:"Zahlen" },
